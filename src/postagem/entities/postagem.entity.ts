...
export class Postagem{
    ...
    usuario!: Usuario // Cria um relacionamento muitos para um com a tabela usuario, onde uma postagem pode ter um usuario e um usuario pode ter muitas postagens, e carrega o usuario automaticamente quando a postagem for carregada
}